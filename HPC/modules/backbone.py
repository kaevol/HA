...
class Backbone(nn.Module):
    ...
    def __init__(self,
        ...
        # Agent embedding: input_dim=4 (velocity_length, velocity_theta, length, width)
    ...
    def forward(self, data: Batch, l_embs: torch.Tensor) -> torch.Tensor:
        # Initialization
        # Agent features: velocity_length, velocity_theta, length, width
        ...
        a_input = torch.stack([a_velocity_length, a_velocity_theta, a_length, a_width], dim=-1)  # [(N1,...,Nb),H,4]
